...
const CACTI_CONFIG = [
  ...
  { width: 48 / 1.5, height: 100 / 1.5, image: "/static/images/ponnu3.png" },
  { width: 98 / 1.5, height: 100 / 1.5, image: "/static/images/pp1.png" },
  { width: 68 / 1.5, height: 70 / 1.5, image: "/static/images/pp1.png" },
];
...
// Define and load the game over sound once (e.g., at game setup)
const gameOverSound = new Audio('/static/sounds/dead.mp3');
gameOverSound.loop = false;
gameOverSound.volume = 1.0;

// Play only after first user interaction (browsers block autoplay)
const startBackgroundMusic = () => {
  backgroundMusic.play().catch((e) => {
    console.warn("Autoplay prevented. Will retry on user interaction.", e);
  });
